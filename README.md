...
* **Instant Conversions**: Convert between 9 inputs and 9 outputs (CSV, JSON, NDJSON, Parquet, Excel, SQLite, SQL, Markdown, HTML).
...
3. **No Tracking**: Opt-in privacy-respecting Plausible analytics toggle only.
